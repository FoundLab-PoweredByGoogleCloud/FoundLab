...
Este pilar substitui logs de texto frágeis por **prova matemática irrefutável**. É o nosso "cartório digital".
  ...
  * **Implementação Técnica:**
    ...
    3.  **Ledger Imutável (WORM):** A trilha de auditoria (`Veritas_Audit_Trail`) é persistida no **Google BigQuery**, configurado como **Write-Once, Read-Many** (WORM).
...
(Controle de Chaves)"]
            VPC_SC["Pilar 2: VPC Service Controls
...
(Custódia do BTG)"]
        ...
        Umbrella -- "3. Prova WORM" --> WORM_Ledger
        
        WORM_Ledger -- "Criptografado com" --> CMEK
        ACL -- "Controlado por" --> VPC_SC
        Umbrella -- "Controlado por" --> VPC_SC
        WORM_Ledger -- "Controlado por" --> VPC_SC
